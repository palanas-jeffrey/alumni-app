<div>
            ...
            <div class="border-1 border-gray-300 p-4 rounded-4">
                <div class="flex justify-between">
                    ...
                    <div class="flex">
                        ...
                        @livewire('tracer.modal-sorting-sections', ['form_id' => $form_id])
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="accordion-item mt-3">
                            <h2 class="accordion-header d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <h3 class="poppins-semibold txt-18">{{ $section->question_section_title }}</h3>
                                </div>
                                <button 
                            ...
                            <div id="collapse-{{ $id }}" class="accordion-collapse collapse" data-bs-parent="#accordion-form-section">
                                <div class="accordion-body bg-light pt-2">
                                    ...
                                    <div>
                                        @livewire('tracer.section-fields', ['section_id' => $id], key('section-fields-' . $id))
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <x-modal name="modal-section-setup"
        ...
        <form wire:submit.prevent="{{ $editingSectionId ? 'updateSection' : 'addSection' }}" class="p-4">
            <div class="mb-4">
                <x-input-label for="question_section_title">Section title</x-input-label>
                <x-textarea-box
                    name="question_section_title"
                    id="question_section_title"
                    wire:model="question_section_title"
                    rows="4"></x-textarea-box>
                @error('question_section_title')
