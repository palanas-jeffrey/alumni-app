<section class="bg-dust-gray h-100 p-4 rounded-4 space-y-6">
    <div>
        <h2 class="poppins-semibold text-lg">Create tracer study form</h2>
        <p class="mt-1 mb-1 text-sm text-gray-600">Create a new tracer study form.</p>
        <div class="flex gap-4 items-center mt-4">
            <x-primary-button type="button" x-data=""
                 x-on:click.prevent="$dispatch('open-modal', 'modal-add-tracer-study-form')">Create</x-primary-button>
        </div>
    </div>

    <x-modal name="modal-add-tracer-study-form"
        ...
        @if($newFormAdded)
            <div class="p-4">
                ...
                <div class="mt-6 flex justify-start">
                    <x-link-btn href="{{ route('tracer.form-edit', ['form_id' => $newForm_id]) }}">
                        View form
                    </x-link-btn>
    ...
    <script>
        window.addEventListener('tracer-study-form-added', function () {
