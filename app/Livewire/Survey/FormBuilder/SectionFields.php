...
class SectionFields extends Component
{
    ...
    public function saveField()
    {
        ...
        SurveySectionField::create($validated);
    ...
    {
        $this->editingField = SurveySectionField::find($fieldId);
    ...
    public function updateField()
    {
        ...
        $field = SurveySectionField::findOrFail($this->field_id);
        $field->update([
    ...
    {
        $field = SurveySectionField::findOrFail($fieldId);
        $field->delete();
        $this->loadFields();
    ...
    {
        return view('livewire.survey.form-builder.section-fields');
    }
}
